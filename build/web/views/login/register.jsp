<%-- 
    Document   : register
    Created on : Feb 17, 2025, 7:12:12 PM
    Author     : Admin
--%>
                ...
                <div class="login-form">
                    ...
                    <form action="register" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="firstname" name="firstname" placeholder="Họ" value="<%= request.getAttribute("firstname") %>" required>
                            <% } else { %>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="lastname" name="lastname" placeholder="Tên" value="<%= request.getAttribute("lastname") %>" required>
                            <% } else { %>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="birthdate" name="birthdate" value="<%= request.getAttribute("birthdate") %>" required>
                            <% } else { %>
                        ...
                        <p class="register">
                            Đã có tài khoản? <a href="/project/login">Đăng nhập ngay</a>
                        </p>
                    </form>
                </div>
            </div>
